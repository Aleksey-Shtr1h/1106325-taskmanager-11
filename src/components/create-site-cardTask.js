...
const createCardTaskTemplate = (task) => {
  ...
  const editBtn = createButtonMarkup(`edit`);
  const archiveBtn = createButtonMarkup(`archive`, !task.isArchive);
  const favoritesBtn = createButtonMarkup(`favorites`, !task.isFavorite);
